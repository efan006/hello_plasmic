...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 6OfI4ryIwId/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: MEzYmnVdD0f/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: kE5UOK1hiRT/icon
  ...
  return (
    ...
    >
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__jYh0L)}
                role={"img"}
              />
            ),
      ...
      <input
        ...
        name={args.name}
        placeholder={
          args.placeholder !== undefined ? args.placeholder : "Password"
        }
        type={"text"}
        value={args.value}
      />
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__xyhec)}
                role={"img"}
              />
            ),
