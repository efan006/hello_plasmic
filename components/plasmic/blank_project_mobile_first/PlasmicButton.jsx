...
import sty from "./PlasmicButton.module.css"; // plasmic-import: hqyq1fU3pvf/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: kE5UOK1hiRT/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: ChgzFVoT56-/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__aIf3W)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__a7Zsa)}
                role={"img"}
              />
            ),
